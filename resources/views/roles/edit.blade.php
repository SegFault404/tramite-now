<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('roles.index') }}" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">Regresar</a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('roles.update', $role->id)}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('name',$role->name) }}" name="name" placeholder="Ingresa Nombre" type="text" 
